  ...
  return (
    <section className="soft-panel px-6 py-5">
      <div className="flex flex-col gap-5 xl:flex-row xl:items-center xl:justify-between">
        <div>
          ...
          <p className="mt-2 max-w-3xl text-sm text-slate-500">
            Give this setup flow to machines that should report package inventory to this Cloud Brain. No enrollment token is required in open-agent mode.
          </p>
        </div>
      ...
      <div className="mt-5 grid grid-cols-1 gap-3 lg:grid-cols-3">
        ...
        <div className="rounded-2xl border border-slate-100 bg-white px-4 py-3">
          <div className="text-[10px] font-black uppercase tracking-[0.18em] text-slate-400">Agent Enrollment</div>
          <div className="mt-2 break-all text-sm font-black text-slate-900">Not required</div>
        </div>
      </div>
    </section>
  )
